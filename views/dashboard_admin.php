                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li><a data-toggle="tab" href="#5">Sedang-Dikerjakan</a></li>
                            <li><a data-toggle="tab" href="#6">Sedang-Dikerjakan-Sesi 2</a></li>
                        ...
                        <div class="tab-content">
                                        ...
                                        if($tiket){
                                            while($row = mysqli_fetch_array($tiket))
                                            {
                                                ...
                                                <td>
                                                    ...
                                                    <form method='post' action='".$base_url."/controller/dikerjakan.php'>
                                                        <input type='submit' name='dikerjakan' value='Dikerjakan'/>
                                    ...
                                    while($row = mysqli_fetch_array($tiket2))
                                        {
                                            ...
                                            <td>
                                                    ...
                                                    <form method='post' action='".$base_url."/controller/dikerjakan.php'>
                                                        <input type='submit' name='dikerjakan2' value='Dikerjakan'/>
                                                        <input type='hidden' name='id' value=".$row['id_tiket'].">
                                                </form>
                                                <form method='post' action='".$base_url."/controller/hapus.php'>
                            ...
                            <div id="4" class="tab-pane fade">
                                ...
                                <?php 
                                $no2 = 1;
                                $tiket2 = mysqli_query($mysqli,"SELECT tiket_sesi2.*, users.name, users.nik, users.mobile FROM tiket_sesi2 INNER JOIN users ON tiket_sesi2.pembuat=users.id WHERE keterangan='selesai'");
                                if($tiket2){
                                    while($row = mysqli_fetch_array($tiket2))
                                        {
                                            echo "<tr>
                            ...
                            <div id="5" class="tab-pane fade">
                                <table id="daftar5" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-resizable="true"
                                        data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" class="table table-striped table-bordered table-hover table-responsive" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th width="col-md-1">No</th>
                                ...
                                <?php 
                                $no2 = 1;
                                $tiket2 = mysqli_query($mysqli,"SELECT tiket.*, users.name, users.nik, users.mobile FROM tiket INNER JOIN users ON tiket.pembuat=users.id WHERE keterangan='sedang dikerjakan'");
                                if($tiket2){
                                    while($row = mysqli_fetch_array($tiket2))
                                        {
                                            echo "<tr>
                            ...
                            <div id="6" class="tab-pane fade">
                                ...
                                <?php 
                                $no2 = 1;
                                $tiket2 = mysqli_query($mysqli,"SELECT tiket_sesi2.*, users.name, users.nik, users.mobile FROM tiket INNER JOIN users ON tiket_sesi2.pembuat=users.id WHERE keterangan='sedang dikerjakan'");
                                if($tiket2){
                                    while($row = mysqli_fetch_array($tiket2))
                                        {
                                            echo "<tr>
